      ...
      <section className="landing-cta">
        <Card padding="lg" className="landing-cta__card">
          <div>
            ...
            <h2 className="landing-section__title">Share your project details and Designova will follow up.</h2>
            <p className="landing-section__description">
              Tell us about your space, your timeline, and the atmosphere you want to create. We&apos;ll take it from there.
            </p>
          </div>
...
export default LandingPageDesignova;
